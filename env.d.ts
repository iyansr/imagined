/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 5d109f55d14c0cde6436e6b4c4104795)
...
declare namespace Cloudflare {
	interface Env {
		...
		IMAGINED_BUCKET: R2Bucket;
		IMAGINED_ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "DATABASE_URL" | "OPEN_ROUTER_API_KEY" | "NEXT_PUBLIC_BETTER_AUTH_URL">> {}
}
